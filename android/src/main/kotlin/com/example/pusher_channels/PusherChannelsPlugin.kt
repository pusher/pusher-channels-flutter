package com.example.pusher_channels
...
const val TAG = "PusherChannels"

/** PusherChannelsPlugin */
class PusherChannelsPlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
    private var activity: FlutterActivity? = null
    private lateinit var methodChannel: MethodChannel
    private var pusher: Pusher? = null
    private var pusherChannels = mutableMapOf<String, Channel>()
    override fun onAttachedToEngine(flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        methodChannel = MethodChannel(flutterPluginBinding.binaryMessenger, "pusher_channels")
